...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="Server">
  ...
  <table width="100%">
    <tr>
      ...
      <td align="right">
        <asp:Button ID="updateButton" runat="server" Text="Update Quantities" CssClass="SmallButtonText"
          OnClick="updateButton_Click" />
        <asp:Button ID="checkoutButton" runat="server" CssClass="SmallButtonText" Text="Proceed to Checkout"
          OnClick="checkoutButton_Click" />
      </td>
    </tr>
  </table>
  <br />
  <asp:Button ID="continueShoppingButton" runat="server" Text="Continue Shopping" CssClass="SmallButtonText"
